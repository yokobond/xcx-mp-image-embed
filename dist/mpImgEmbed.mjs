...
var en$1 = {
	"mpImgEmbed.entry.name": "Image Embedding",
	"mpImgEmbed.entry.description": "Description of this extension"
};
var ja$1 = {
	"mpImgEmbed.entry.name": "Image Embedding",
	"mpImgEmbed.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"mpImgEmbed.entry.name": "Image Embedding",
	"mpImgEmbed.entry.description": "かくちょうきのうのせつめい"
}
};
...
var en = {
	"mpImgEmbed.name": "Image Embedding",
	"mpImgEmbed.doIt": "do it [SCRIPT]"
};
var ja = {
	"mpImgEmbed.name": "Image Embedding",
	"mpImgEmbed.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
	"ja-Hira": {
	"mpImgEmbed.name": "Image Embedding",
	"mpImgEmbed.doIt": "[SCRIPT] をじっこうする"
}
};
 ...
 * @type {string}
 */
var extensionURL = 'https://yokobond.github.io/xcx-mp-imgembed/dist/mpImgEmbed.mjs';
...
//# sourceMappingURL=mpImgEmbed.mjs.map
