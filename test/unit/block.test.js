...
describe("ExtensionBlocks", () => {
    ...
    describe("Static properties", () => {
        ...
        test("should have EXTENSION_ID", () => {
            expect(blockClass.EXTENSION_ID).toBe("mpImageEmbed");
        });

        test("should have extensionURL", () => {
            expect(blockClass.extensionURL).toBe("https://yokobond.github.io/xcx-mp-image-embed/dist/mpImageEmbed.mjs");
        });
    ...
    describe("getInfo", () => {
        ...
        test("should have correct extension ID", () => {
            const info = block.getInfo();
            expect(info.id).toBe("mpImageEmbed");
        });
